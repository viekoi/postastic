...
import Topbar from "@/components/protected/top-bar";
  ...
  return (
    <div className="">
      ...
      <div className="mx-auto grid grid-cols-4 max-w-[1280px] min-h-screen relative">
        <LeftSidebar />
        <div className="lg:col-span-2 col-span-full flex w-full h-full flex-col border-l-[0.5px] border-r-[0.5px] border-gray-600">{children}</div>
